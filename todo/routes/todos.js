...
var templates = {
    index: fs.readFileSync(__dirname + '/../templates/todos/index.html', 'utf8'),
    'new': fs.readFileSync(__dirname + '/../templates/todos/new.html', 'utf8')
};
    ...
    this.get('/', [loggedIn,
        function () {
            ...
            db.get(this.req.session.user.email, function (err, todos) {
                ...
                var map = Plates.Map();
                map.class('todo').to('todo');
                map.class('pos').to('pos');
                map.class('what').to('what');
